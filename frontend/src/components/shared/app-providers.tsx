 ...
 * surface, the nuqs URL-state adapter, the PWA provider, and the connectivity
 * boundary, keeping those browser-only providers out of the root layout so
 * route segments stay Server Components.
 */
