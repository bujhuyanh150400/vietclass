/** Query parameters that identify one page of a list. */
...
export const academicQueryKeys = {
  subjects: {
    ...
    list: (params: ListParams) => ["academic", "subjects", "list", params] as const,
  ...
  classes: {
    ...
    list: (params: ListParams) => ["academic", "classes", "list", params] as const,
  ...
  students: {
    ...
    list: (params: ListParams) => ["academic", "students", "list", params] as const,
    detail: (id: number) => ["academic", "students", "detail", id] as const,
  },
  enrollments: {
    root: () => ["academic", "enrollments"] as const,
    list: (classId: number, params: ListParams) =>
      ["academic", "enrollments", "list", classId, params] as const,
    available: (classId: number, params: ListParams) =>
