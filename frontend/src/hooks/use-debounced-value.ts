 ...
 * the input itself responsive while the value the caller reacts to settles. The
 * shared search toolbar and async selectors use the same pause for consistency.
 */
