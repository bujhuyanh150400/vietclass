...
final class ClassResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'teacher_name' => $this->whenLoaded('teacher', fn (): ?string => $this->teacher?->full_name),
            'grade_level' => $this->grade_level->value,
            'base_fee_per_session' => (int) $this->base_fee_per_session,
            'teacher_salary_per_session' => (int) $this->teacher_salary_per_session,
