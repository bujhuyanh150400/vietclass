...
final class StudentProfile extends Model
{
     ...
     *
     * The rule for "still attending" is deliberately not restated here: it comes
     * from `ClassEnrollment::active()`, the single definition that class rosters and
     * capacity counts already share.
     *
