...
| Schedule | [Buổi học theo ngày](schedule/buoi-hoc.md) | Xem lịch học theo khoảng ngày từ buổi ảo chiếu ra lịch cố định, và vật thể hoá một buổi ảo thành buổi học có `id`. |
