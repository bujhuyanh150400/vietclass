...
| Files | [Quản lý tệp](files/quan-ly-tep.md) | Thư viện tệp riêng tư theo tài khoản, hạn mức lưu trữ theo vai trò, thùng rác 30 ngày và liên kết tạm thời để mở nội dung. |
| Identity | [Ảnh đại diện hồ sơ](identity/avatar.md) | Ảnh đại diện dùng chung cho tài khoản, học sinh và giáo viên: không dùng ảnh, ảnh trong thư viện tệp, hoặc ảnh DiceBear dựng tại thiết bị. |
