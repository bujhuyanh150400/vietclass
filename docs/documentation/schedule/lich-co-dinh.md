...
Related Task: `.tasks/schedule-phase-2-templates.md`
...
Đây là nền cho việc xác định từng buổi học theo ngày ở giai đoạn sau. Phase hiện tại chưa sinh buổi học nào: hệ thống chỉ giữ khai báo lịch và chặn cứng việc xếp trùng phòng hoặc trùng giáo viên giữa các lịch cố định.
...
- **Xóa** chỉ được phép khi `start_date` còn ở tương lai. Lịch đã có hiệu lực là lịch sử đã diễn ra, phải dùng đường đóng.
...
| Buổi học chi tiết | Hạ nguồn chưa có | Từng buổi học theo ngày sẽ được xác định từ lịch cố định và kế thừa danh sách giáo viên của nó. | Hiện chưa có buổi học nào trong hệ thống. |

## Giới hạn hiện tại

- Chưa có buổi học theo ngày: phase này chỉ giữ khai báo lịch, chưa xác định được buổi học nào và chưa có endpoint xem lịch theo khoảng ngày.
- Chưa có màn hình quản trị cho lịch cố định.
- Xóa lịch chỉ kiểm `start_date` còn ở tương lai; khi đã có buổi học, điều kiện này còn phải siết thêm theo các buổi đã tham chiếu.
- Không sửa được lịch tại chỗ theo thiết kế. Một lần sửa luôn để lại thêm một dòng lịch sử.
- Chống trùng chỉ so giữa các **lịch cố định** với nhau; chưa có buổi học để so.
